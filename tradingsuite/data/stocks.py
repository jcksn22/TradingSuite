...
class StockData:
    ...
    def plot_smma_ribbon(self, plot_title, plot_height=900, ndays=800, ad_local_min_max=True):
        """
        Plot interactive chart with SMMA ribbon indicator analyzing the local minimums and maximums
        Parameters:
        - plot_title: str, title of the plot
        - plot_height: int, height of the plot
        - ndays: int, number of days to plot
