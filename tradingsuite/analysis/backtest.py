    ...
    def summary_of_trades(self):
        ...
        if num_trades == 0:
            self.trades_summary = {
                ...
                'win_ratio(%)': 0,
                'average_res(%)': 0,
                'average_trade_len(days)': 0,
                'median_res(%)': 0,
                'cumulative_result': '0 x',
                'trade_results': 'No trades',
                'profitable_trade_results': 'No trades',
                'profitable_trades_mean': 0,
                'profitable_trades_median': 0,
                'looser_trade_results': 'No trades',
                'looser_trades_mean': 0,
                'looser_trades_median': 0,
                'median_trade_len(days)': 0,
            ...
            self.trade_summary_plot_text = "No trades generated by this strategy"
            return
        
        self.trades_summary = {
          'ticker' : self.data['ticker'].iloc[0],
          'number_of_trades' : num_trades,
          'win_ratio(%)' : round(((sum(self.trades['result'] >1) / num_trades)*100),2),
